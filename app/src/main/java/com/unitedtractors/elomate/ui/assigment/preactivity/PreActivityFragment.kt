...
import com.unitedtractors.elomate.ui.assigment.DetailAssigmentActivity
...
class PreActivityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (courseId != 0) {
            ...
            // Handle jika courseId tidak valid
            ...
            when (result) {
                ...
                is Result.Success -> {
                    ...
                    val adapter = PreActivityAdapter(preActivityList) { assignmentId ->
                        val intent = Intent(requireContext(), DetailAssigmentActivity::class.java)
