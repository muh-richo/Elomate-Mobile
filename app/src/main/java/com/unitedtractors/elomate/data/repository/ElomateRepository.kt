...
class ElomateRepository(
    ...
    fun getEducationById(token: String, educationId: Int): LiveData<Result<EducationResponse, MessageErrorResponse>> =
        liveData {
            ...
            try {
                val response = elomateApiService.getEducationById(token, educationId)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse =
    ...
    fun getEducationLevel(token: String): LiveData<Result<List<String>, MessageErrorResponse>> =
        liveData {
            ...
            try {
                val response = elomateApiService.getEducationLevel(token)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse =
    ...
    fun getAnnouncement(token: String): LiveData<Result<NotificationResponse, MessageErrorResponse>> =
        liveData {
            ...
            try {
                val response = elomateApiService.getNotification(token)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse =
    ...
    fun getCourseProgress(token: String): LiveData<Result<List<CourseResponse>, MessageErrorResponse>> =
        liveData {
            ...
            try {
                val response = elomateApiService.getCourseProgress(token)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse = Gson().fromJson(errorBody, MessageErrorResponse::class.java)
    ...
    fun getQuestionAssignment(token: String, assignmentId: Int): LiveData<Result<List<QuestionResponse>, MessageErrorResponse>> =
        liveData {
            emit(Result.Loading)
            try {
                val questionItems = elomateApiService.getQuestionAssignment(token, assignmentId)
                emit(Result.Success(questionItems))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse =
                    Gson().fromJson(errorBody, MessageErrorResponse::class.java)
    ...
    fun submitAnswerMultiple(token: String, assignmentId: Int, answer: List<AnswerMultipleChoiceRequest>): LiveData<Result<SuccessResponse, MessageErrorResponse>> =
        liveData {
            emit(Result.Loading)
            try {
                val response = elomateApiService.submitAnswerMultipleChoice(token, assignmentId, answer)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse = Gson().fromJson(errorBody, MessageErrorResponse::class.java)
    ...
    fun submitAnswerEssay(token: String, assignmentId: Int, essayAnswer: String, filePath: String): LiveData<Result<SuccessResponse, MessageErrorResponse>> =
        liveData {
            emit(Result.Loading)
            try {
                ...
                val filePart = MultipartBody.Part.createFormData("lampiran_file", file.name, requestFile)

                val response = elomateApiService.submitAnswerEssay(token, assignmentId, essayAnswerBody, filePart)
                emit(Result.Success(response))
            } catch (e: HttpException) {
                val errorBody = e.response()?.errorBody()?.string()
                val messageErrorResponse =
