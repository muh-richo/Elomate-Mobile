...
class LocationEditText @JvmOverloads constructor(
    ...
    private var iconDomisili: Drawable = ContextCompat.getDrawable(context, R.drawable.ic_location) as Drawable
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        setEditTextDrawables(startOfTheText = iconDomisili)
    }
