...
class EditProfileViewModel(private val repository: ElomateRepository) : ViewModel() {
    ...
    fun updateProfile(token: String, email: String, divisi: String, posisi: String, domisili: String, tempatLahir: String, tanggalLahir: String, noHp: String) =
        repository.updateProfile(token, email, divisi, posisi, domisili, tempatLahir, tanggalLahir, noHp)
